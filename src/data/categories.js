    ...
    commodities: [
      {
        ...
        related: ['silver', 'platinum', 'copper'],
      },
      {
        slug: 'silver',
        name: 'Silver',
    ...
    commodities: [
      {
        ...
        related: ['natural-gas', 'gasoline', 'heating-oil'],
      },
      {
        slug: 'natural-gas',
        name: 'Natural Gas',
        ...
        related: ['crude-oil', 'heating-oil', 'coal'],
      },
      {
        slug: 'gasoline',
        name: 'Gasoline',
        ...
        related: ['crude-oil', 'heating-oil', 'natural-gas'],
      },
      {
        slug: 'heating-oil',
        name: 'Heating Oil',
        ...
        related: ['crude-oil', 'natural-gas', 'gasoline'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    commodities: [
      ...
      },
      {
        ...
        related: ['copper', 'aluminum', 'nickel'],
      },
      {
        slug: 'nickel',
        name: 'Nickel',
    ...
    commodities: [
      {
        ...
        related: ['feeder-cattle', 'lean-hogs', 'corn'],
      },
      {
        slug: 'lean-hogs',
        name: 'Lean Hogs',
        ...
        related: ['live-cattle', 'feeder-cattle', 'corn'],
      },
      {
        slug: 'feeder-cattle',
        name: 'Feeder Cattle',
        ...
        related: ['live-cattle', 'lean-hogs', 'corn'],
      },
    ],
  },
]
